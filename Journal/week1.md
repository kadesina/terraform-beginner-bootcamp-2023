...
[Meta Arguent Lifecycle](https://developer.hashicorp.com/terraform/language/meta-arguments/lifecycle)
...
Provisiuoners allow you to execute commands on computer instances eg. AWS CLI command. 

They are not recommendded for use by Hashicorp because configuration Mangament tools such as ANsible are a better fit, but the functionality exits.
...
This will execute commands on a machine which you target. You will need to provide credentials such as ssh to get into the machince. 
...
For eachf allows us to enumerate over complex data types

```sh
[for s in var.list : upper(s)]
```

This is mostly useful when you are creating multiples of a cloud resource and you wanbt to reduce the amount of repetitive terraform code.
